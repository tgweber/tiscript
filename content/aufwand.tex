...
Wie können wir die Überlegungen aus dem vorherigen Abschnitt generalisieren,
...
müssen wir noch eine Lösung für diese Ambivalenz finden.
Dafür gibt es prinzipiell drei Szenarien:
\begin{itemize}
    ...
    \item \textbf{Average Case}: Wir nutzen statistische Methoden,
        ...
        ermitteln wir die Laufzeit für alle Worte und mitteln diese.
