...
\begin{tikzpicture}
    ...
    ;
\end{tikzpicture}
\caption{$tm_{REVERSE}$\\(siehe auch: \url{https://turingmachinesimulator.com/shared/icyilbjidr})}
\label{fig:tmreverse}
\end{figure}
...
Da $|l_{10,tm_{REVERSE}}| = 22$ hat $\tau$ in diesem Fall also den folgenden Wert:
\[
\tau(10,tm) = 21
\]
