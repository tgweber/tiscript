...
etwas das in unterschiedlichem Gewand in der Praxis wieder- und wiederkehrt.
...
in Libraries, Best Practices und Dokumentationen festgehalten werden.
...
Um dies besser fassen zu können,
wollen wir die Formalisierung des \textbf{EVEN}-Problems beispielhaft durchgehen.
...
Um Bedingung 1 (Unabhängigkeit von bestimmten Maschinen und Programmiersprachen) zu erfüllen,
...
Klar ist allerdings auch, dass wir uns für das Beispiel
auf irgendeine Informationskodierung festlegen müssen.
Aus diesem Grund nutzen wir für das Beispiel \textbf{EVEN}
die wohlbekannte binäre Kodierung von Zahlen,
nennen sie aber gleichzeitig \emph{kanonisch}. 
