...
aber formale Sprachen sind nicht Problemen gleichzusetzen.\footnote{Man kann sogar beweisen,
dass es mehr Funktionen (also Probleme) gibt, als formale Sprachen. TODO: Referenz}

Warum nutzen wir in diesem Skript dann dennoch formale Sprachen,
um Probleme in der theoretischen Informatik zu formalisieren?

Offenkundig sind formale Sprachen,
wie wir sie im vorangegangenen Abschnitt kennengelernt haben,
für praktische Anwendungen ungeeignet:
Sie sind sehr sperrig für die Auffassungsgabe der meisten Menschen 
(was auch an Gewohnheiten liegen mag),
Sie machen praktische Aufgaben,
wie das programmieren von Software nicht einfacher oder schneller
und sie
