...
Dieses Kapitel soll in konziser Weise Ergebnisse der folgenden Fächer zusammenfassen,
...
In diesem Abschnitt werden wir die folgenden Schritte abarbeiten
...
Man kann auch eine Relation auch in der Infix-Notation angeben,
dann  entspricht sie den mathematischen Sehgewohnheiten: $a <_{ABC} d$ oder $f <_{ABC} x$.

\noindent
Folgende Sachverhalte sollten bekannt sein:
\begin{itemize}
    \item Eine Relation ist symmetrisch, wenn gilt: $\forall x,y(xRy \leftrightarrow yRx)$.
    \item Eine Relation ist reflexiv, wenn gilt: $\forall x(xRx)$.
    \item Eine Relation ist transitiv, wenn gilt: $\forall x,y,z(xRy \wedge yRz \rightarrow xRz)$.
...
\begin{itemize}
    ...
    \item Bei mehrstelligen Funktionen muss eine Signatur angeben, was zur Definitions-
        ...
        \[ between: \Sigma \rightarrow \Sigma \times \Sigma \]
\end{itemize}

\section{Beweisstrategien}\label{bew}
