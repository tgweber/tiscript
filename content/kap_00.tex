...
Die Prädikatenlogik erlaubt es also Quantoren beliebig komplex zu kombinieren.
Dies hat es nicht nur ermöglicht zentrale Ergebnisse der Mathematik im Allgemeinen
präzise zu formulieren,\footnote{
    Ein Beispiel ist der Konvergenzbegriff, siehe \cite{link}, 10
}
sie ermöglichen es auch wichtige Ergebnisse der theoretischen Informatik zu formalisiern.
